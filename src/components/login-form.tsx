  ...
  return (
    <div className="flex w-full max-w-sm flex-col items-center gap-8">
      <div className="flex flex-col items-center gap-2 text-center">
        <h1 className="text-2xl font-bold text-primary">Sunday Play</h1>
        <p className="text-sm text-muted-foreground">
          로그인하고 더 많은 게임 가이드를 확인하세요
        </p>
      </div>

      <button
        onClick={signInWithGoogle}
        className="flex h-11 w-full items-center justify-center gap-3 rounded-lg border border-border bg-card
