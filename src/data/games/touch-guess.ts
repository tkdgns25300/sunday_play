...
const touchGuess: Game = {
    ...
    description:
        "팀별 대표가 안대를 쓰고 물건을 손으로 만져 무엇인지 맞추는 게임입니다. 팀별로 순서대로 도전하며, 제한 시간 1분 안에 맞추면 점수를 얻습니다. 가장 많은 점수를 얻은 팀이 우승합니다.",
    ...
    steps: [
        {
            title: "준비",
            content:
                "팀을 나누고 팀별 도전 대표 순서를 정합니다.\n맞출 물건들을 상자나 보자기로 가려서 준비합니다.",
        },
        {
            title: "게임 진행",
            content:
                "팀 대표가 안대를 착용합니다.\n진행자가 물건을 도전자 앞에 놓으면, 1분 안에 만져서 정답을 말합니다.\n맞추면 팀이 점수를 얻습니다.\n시간이 지나거나 틀리면 다음 팀 대표가 다른 물건으로 도전합니다.",
        },
        {
            title: "우승",
            content:
                "모든 물건이 끝난 후 가장 많은 점수를 얻은 팀이 우승합니다.",
        },
    ],
    materials: [
        {
            ...
            isOptional: false,
            purchaseUrl:
                "https://www.coupang.com/np/search?component=&q=%EC%95%88%EB%8C%80",
        },
        {
            name: "맞출 물건 (과일, 문구류, 장난감, 생활용품 등)",
            quantity: "10개 이상",
            isOptional: false,
        },
    ],
    ...
    variations: [
        ...
        },
        {
            condition: "난이도 상향",
            suggestion:
                "장갑을 끼고 맞추거나, 비슷한 물건끼리 구별하게 합니다. (예: 사과와 배, 연필과 볼펜)",
        },
        {
            condition: "힌트 허용",
            suggestion:
                "어려운 물건이 나왔을 때 진행자가 힌트를 줍니다. (예: \"먹는 거예요\", \"학교에서 써요\")",
        },
        {
            condition: "성경 특화",
            suggestion:
                "성경 관련 물건을 사용합니다. (예: 십자가, 성경책, 포도, 빵 등)",
        },
    ],
    tips: [
        "쉬운 물건(바나나, 연필)부터 시작해서 어려운 물건(비슷한 크기의 과일 구별)으로 난이도를 올리세요.",
    ],
    safetyNotes: [
