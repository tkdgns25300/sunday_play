...
- [ ] 통신판매업 신고 — 안동시청에 전화하여 "신용카드만 사용하는 디지털 콘텐츠 서비스, 에스크로 가입 대상 아님, 구매안전서비스 이용확인증 대신 PG 계약서 등 다른 소명자료로 대체 가능한지" 확인 필요 (기존 신청건은 KCP 계약서 캡쳐로 제출했으나 반려됨)
- [ ] 통신판매업 신고번호 푸터에 추가
- [x] 카드사 등록심사 신청 (partner.kcp.co.kr) — 심사 중 (2026-03-26 신청, 3일~15일 소요)
...
- [x] 계산합시다 — 진행 PPT(pptx/pdf) + 숫자 카드(pdf/hwpx) 완료
- [x] 단어 스피드 퀴즈 — 진행 PPT(pptx/pdf) 완료
- [ ] 색판 뒤집기 빙고 — 진행 자료 제작
- [ ] 물병 세우기 — 진행 자료 제작
- [ ] 신규 게임별 PPT + 준비물 자료 제작
...
- [x] 계산합시다 — 데이터 보완 완료 (steps, variations, safetyNotes, bibleConnections)
- [x] 단어 스피드 퀴즈 — 데이터 보완 완료 (플러스/마이너스 점수 방식)
- [ ] 색판 뒤집기 빙고 — 데이터 보완
- [ ] 물병 세우기 — 데이터 보완
- [ ] 게임 데이터 50개 이상으로 확충
