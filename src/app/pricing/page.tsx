...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      "크레딧을 충전한 후, 원하는 게임의 진행 자료(PPT, PDF, PNG)를 개별 구매할 수 있습니다. 게임마다 가격이 다르며, 구매한 게임은 언제든 재다운로드 가능합니다.",
  },
  {
  ...
  {
    question: "진행 PPT는 어떤 형태인가요?",
    answer:
      "게임 규칙 설명용 슬라이드이며, PPT(편집 가능), PDF(발표용), PNG 이미지를 함께 제공합니다. 다운로드 후 바로 화면에 띄워 사용할 수 있습니다.",
  },
  {
